  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <div className="flex justify-between items-center mb-6">
        ...
        <Link to="/orders/new" className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
          New Order
        </Link>
      </div>
      ...
      <div className="flex justify-between items-center mt-4">
        ...
        <div className="flex space-x-2">
          <button 
            ...
            disabled={page === 0}
            className={`px-3 py-1 border rounded ${page === 0 ? 'bg-gray-100 text-gray-400' : 'hover:bg-gray-100'}`}
          >
            Previous
          </button>
          <button 
            ...
            className={`px-3 py-1 border rounded ${page >= orderData.totalPages - 1 ? 'bg-gray-100 text-gray-400' : 'hover:bg-gray-100'}`}
          >
            Next
          </button>
        </div>
