...
import { UtensilsCrossed, ShoppingCart, Truck, CreditCard, TrendingUp, Users, Clock, AlertCircle } from 'lucide-react';

function AdminDashboard() {
  return (
    <div className="flex flex-col min-h-screen">
      {/* Top navigation components - fixed at the top */}
      ...
      <div className="flex flex-1 pt-32">
        ...
        {/* Main content */}
        <main className="flex-1 ml-64 pb-0">
